...
namespace DBHandIn3
{
    public partial class TreatmentsAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LabelMessage.Text = Session["admin_name"].ToString();
        ...
        protected void ButtonShowTR_Click(object sender, EventArgs e)
        {
